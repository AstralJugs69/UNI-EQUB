...
- The `group-formation` Edge Function currently provides the Phase 2 command boundary and the initial create-request branch; list/join/admin workflows are being added incrementally.
