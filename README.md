...
- The `group-formation` Edge Function currently provides the Phase 2 command boundary, initial create-request branch, and public forming-group discovery; join/admin workflows are being added incrementally.
