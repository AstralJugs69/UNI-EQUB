...
- The `group-formation` Edge Function currently provides the Phase 2 command boundary, initial create-request branch, public forming-group discovery, request-to-join branch, creator participant management, invite acceptance, and submit-for-approval; admin approval is being added incrementally.
