...
- The `group-formation` Edge Function currently provides the Phase 2 command boundary, initial create-request branch, public forming-group discovery, and request-to-join branch; participant management/admin workflows are being added incrementally.
