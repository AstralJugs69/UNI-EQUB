...
- The `group-formation` Edge Function currently provides the Phase 2 command boundary skeleton; detailed create/list/join/admin workflows are being added incrementally.
