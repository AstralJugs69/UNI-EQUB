...
- Phase 2 round obligation generation: `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `mobile/scripts/validate-phase2-round-obligations.js`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json`
...
| P2-05 | P2-OBLIG | Phase 4 | Add contribution obligations and mock provider attempt lifecycle | In Progress | `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json` | Round readiness is obligation-based and duplicate callbacks are idempotent | Open-round obligation generation exists; dashboard/status, provider attempts, payment routing, and readiness changes remain pending |
