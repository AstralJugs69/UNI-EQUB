...
| P2-04 | P2-FORM | Phase 3 | Add group formation lobby backend and service contract migration | In Progress | `supabase/functions/group-formation/index.ts`, `supabase/functions/_shared/contracts.ts`, `mobile/src/services/live/liveGroupFormationService.ts`, `mobile/src/screens/member/FormationDetailScreen.tsx`, `mobile/src/screens/member/FormationCreatorScreen.tsx`, `Build/delivery/evidence/phase2-formation-validation.json`, `Build/delivery/evidence/phase2-legacy-group-compatibility.json`, `Build/delivery/evidence/phase2-mobile-formation-validation.json`, `Build/delivery/evidence/phase2-member-formation-ui-validation.json`, `Build/delivery/evidence/phase2-creator-formation-ui-validation.json` | User-facing group creation can gather members before canonical group approval | Backend create/list/join/participant/invite/submit/admin approval branches exist; legacy create-request compatibility, mobile service coverage, member discovery/detail UI, and creator setup/management UI are covered; admin UI migration remains pending |
