...
- Phase 2 round obligation generation/status/payment-attempt initiation: `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `supabase/functions/_shared/obligations.ts`, `supabase/functions/_shared/paymentAttempts.ts`, `supabase/functions/group-lifecycle/index.ts`, `supabase/functions/payment-attempt/index.ts`, `mobile/scripts/validate-phase2-round-obligations.js`, `mobile/scripts/validate-phase2-dashboard-obligations.js`, `mobile/scripts/validate-phase2-payment-attempt-initiation.js`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json`, `Build/delivery/evidence/phase2-dashboard-obligation-status-validation.json`, `Build/delivery/evidence/phase2-payment-attempt-initiation-validation.json`
...
| P2-05 | P2-OBLIG | Phase 4 | Add contribution obligations and mock provider attempt lifecycle | In Progress | `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `supabase/functions/_shared/obligations.ts`, `supabase/functions/_shared/paymentAttempts.ts`, `supabase/functions/group-lifecycle/index.ts`, `supabase/functions/payment-attempt/index.ts`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json`, `Build/delivery/evidence/phase2-dashboard-obligation-status-validation.json`, `Build/delivery/evidence/phase2-payment-attempt-initiation-validation.json` | Round readiness is obligation-based and duplicate callbacks are idempotent | Open-round obligation generation, dashboard/status obligation counts, and payment-attempt initiation exist; direct payment routing, callback verification, direct obligation payment updates, ledger writes, and readiness changes remain pending |
