...
| P2-04 | P2-FORM | Phase 3 | Add group formation lobby backend and service contract migration | In Progress | `supabase/functions/group-formation/index.ts`, `supabase/functions/_shared/contracts.ts`, `mobile/src/services/live/liveGroupFormationService.ts`, `mobile/src/screens/member/FormationDetailScreen.tsx`, `Build/delivery/evidence/phase2-formation-validation.json`, `Build/delivery/evidence/phase2-legacy-group-compatibility.json`, `Build/delivery/evidence/phase2-mobile-formation-validation.json`, `Build/delivery/evidence/phase2-member-formation-ui-validation.json` | User-facing group creation can gather members before canonical group approval | Backend create/list/join/participant/invite/submit/admin approval branches exist; legacy create-request compatibility, mobile service coverage, and member discovery/detail UI are covered; creator/admin UI migration remains pending |
