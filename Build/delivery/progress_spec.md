...
- Phase 2 round obligation generation/status: `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `supabase/functions/_shared/obligations.ts`, `supabase/functions/group-lifecycle/index.ts`, `mobile/scripts/validate-phase2-round-obligations.js`, `mobile/scripts/validate-phase2-dashboard-obligations.js`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json`, `Build/delivery/evidence/phase2-dashboard-obligation-status-validation.json`
...
| P2-05 | P2-OBLIG | Phase 4 | Add contribution obligations and mock provider attempt lifecycle | In Progress | `supabase/functions/_shared/rounds.ts`, `supabase/functions/_shared/roundLifecycle.ts`, `supabase/functions/_shared/obligations.ts`, `supabase/functions/group-lifecycle/index.ts`, `Build/delivery/evidence/phase2-round-obligation-generation-validation.json`, `Build/delivery/evidence/phase2-dashboard-obligation-status-validation.json` | Round readiness is obligation-based and duplicate callbacks are idempotent | Open-round obligation generation and dashboard/status obligation counts exist; provider attempts, payment routing, direct obligation payment updates, and readiness changes remain pending |
