...
| M8 Phase 2 Expansion | Expansion specs and tracker exist; additive foundation migration, shared helper/type scaffolding, group-formation command boundary, create-request branch, public-discovery branch, request-to-join branch, and participant-management branch now exist with local validation evidence | In Progress |
