...
export const seedGroups: GroupRecord[] = [
  ...
  {
    Group_ID: 'group-market-run',
    Creator_ID: 'user-miki',
    Group_Name: 'Market Run Rotation',
    Amount: 650,
    Max_Members: 12,
    Frequency: 'Bi-weekly',
    Virtual_Acc_Ref: 'UEQ-2201',
    Status: 'Active',
    Start_Date: '2026-03-18',
    Description: 'Bi-weekly contribution circle for groceries, transport, and shared market purchases.',
  },
  {
    Group_ID: 'group-hostel-upgrade',
    Creator_ID: 'user-ruth',
    Group_Name: 'Hostel Upgrade Pot',
    Amount: 800,
    Max_Members: 6,
    Frequency: 'Monthly',
    Virtual_Acc_Ref: 'UEQ-3188',
    Status: 'Active',
    Start_Date: '2026-03-11',
    Description: 'Higher-value monthly pool for laptop repairs, desks, and room setup costs.',
  },
  {
    Group_ID: 'group-exam-week',
    Creator_ID: 'user-saba',
    Group_Name: 'Exam Week Buffer',
    Amount: 250,
    Max_Members: 14,
    Frequency: 'Weekly',
    Virtual_Acc_Ref: 'UEQ-4110',
    Status: 'Active',
    Start_Date: '2026-03-22',
    Description: 'Short-cycle emergency buffer for printouts, meals, and transport during exam periods.',
  },
  {
    Group_ID: 'group-book',
    Creator_ID: 'user-saba',
  ...
  {
    Group_ID: 'group-lab-frozen',
    Creator_ID: 'user-dawit',
    Group_Name: 'Lab Equipment Cycle',
    Amount: 550,
    Max_Members: 7,
    Frequency: 'Monthly',
    Virtual_Acc_Ref: 'UEQ-5122',
    Status: 'Frozen',
    Start_Date: '2026-02-12',
    Description: 'Frozen showcase group representing a compliance-held cycle.',
  },
];
